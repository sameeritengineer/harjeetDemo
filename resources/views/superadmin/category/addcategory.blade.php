              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST"  action="{{route('admin.store_category')}}"  enctype="multipart/form-data" >
                      @csrf
                        <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <!-- <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="state" name="state" placeholder="Ropar" />
                          </div> -->
                          <!-- <div class="mb-3 col-md-6">
                          ...
                          <!-- <div class="mb-3 col-md-6">
                            ...
                            <input id="country_selector" type="text" class="form-control" name="country"   style="width:100%;">  
                          </div> -->
                          <!-- <div class="mb-3 col-md-6">
