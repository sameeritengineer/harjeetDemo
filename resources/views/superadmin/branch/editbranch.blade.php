              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST"  action=" {{ route('admin.update_branch',$branch->id) }} "  enctype="multipart/form-data" >
                      @csrf
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" name="role" id="role"  placeholder="role"  value="{{$branch->role}}"/>
                          </div>
                          <div class="mb-3 col-md-6">
